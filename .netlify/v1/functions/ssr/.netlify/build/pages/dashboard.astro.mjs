...
const $$Dashboard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$BaseLayout, { "title": "Luna - Inicio" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mx-auto"> ${renderComponent($$result2, "Hero", $$Hero, { "title": "Bienvenido," }, { "default": ($$result3) => renderTemplate`<h1 class="text-3xl">${user?.displayName || "Usuario"}</h1>` })} <br> <hr class="w-[70%] mx-auto border-violet-600"> <br> <p class="text-center">Nos alegra verte aquí</p> </div> ` })}`;
