...
const Cards = ({ id, text, success, nombre }) => {
  ...
  return (
    ...
    <div className="w-80 h-80 sm:w-72 sm:mx-auto xl:w-80 xl:h-80 relative p-5 m-5 border border-violet-900 rounded items-center text-base hover:scale-110 transition duration-300 grid">
