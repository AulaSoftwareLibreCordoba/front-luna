...
const Cards = ({ id, text }) => {
  return (
    <div className="w-48 h-48 relative p-2 m-5 flex border border-violet-900 rounded justify-center items-center  text-base hover:scale-125 transition duration-300">
