...
const Cards = ({ id, text, success, nombre }) => {
  ...
  return (
    ...
    <div className="w-64 h-64 sm:w-72 sm:h-72 md:w-[19rem] md:h-[19rem] xl:w-[20rem] xl:h-[20rem] 2xl:w-[20rem] 2xl:h-[20rem] relative p-5 m-5 border mx-auto border-violet-900 rounded items-center text-base hover:scale-110 transition duration-300 grid">
