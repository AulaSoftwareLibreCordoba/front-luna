/* empty css                                        */
import { c as createComponent, e as renderUniqueStylesheet, f as renderScriptElement, g as createHeadAndContent, r as renderTemplate, d as renderComponent, u as unescapeHTML, m as maybeRenderHead, h as renderSlot, b as createAstro, a as addAttribute } from '../../chunks/astro/server_BZCkA_Su.mjs';
import 'kleur/colors';
import pLimit from 'p-limit';
import { A as AstroError, U as UnknownContentCollectionError, q as prependForwardSlash } from '../../chunks/astro/assets-service_C1ND-1e5.mjs';
import { $ as $$BaseLayout } from '../../chunks/BaseLayout_CmOZTSLB.mjs';
import { a as $$Icon, $ as $$Hero } from '../../chunks/Footer_DEfN_QFa.mjs';
import 'clsx';
/* empty css                                     */
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    let entries = [];
    if (!Object.assign({"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": undefined, "SSR": true}, { Path: process.env.Path })?.DEV && cacheEntriesByCollection.has(collection)) {
