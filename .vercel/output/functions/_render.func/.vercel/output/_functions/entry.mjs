...
await import('./chunks/astro/env-setup_xKHvCosB.mjs').then((mod) => mod.setGetEnv((key) => process.env[key])).catch(() => {
});
apply();
...
const _args = {
    "middlewareSecret": "6d2fd018-7004-4fdf-9585-229308dd14bc",
