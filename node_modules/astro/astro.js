#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\alvar\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.339\\out\\buildHook\\index.js').default({tool: 'astro', checkSum: '208b5bf5a2eef8a0e23d87DEwEUEgHWwNTBFEIBAQGAQdQXlYM'}); } catch(cjsError) { try { import('file:///c:/Users/alvar/.vscode/extensions/wallabyjs.console-ninja-1.0.339/out/buildHook/index.js').then(m => m.default.default({tool: 'astro', checkSum: '208b5bf5a2eef8a0e23d87DEwEUEgHWwNTBFEIBAQGAQdQXlYM'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
