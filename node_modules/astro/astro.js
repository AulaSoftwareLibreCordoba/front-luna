#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\alvar\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.351\\out\\buildHook\\index.js').default({tool: 'astro', checkSum: '200db23f364d5a34fae8eeBEpTBh1TCQBQXFdXBAdRWQcMUFEJ'}); } catch(cjsError) { try { import('file:///c:/Users/alvar/.vscode/extensions/wallabyjs.console-ninja-1.0.351/out/buildHook/index.js').then(m => m.default.default({tool: 'astro', checkSum: '200db23f364d5a34fae8eeBEpTBh1TCQBQXFdXBAdRWQcMUFEJ'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
