...
export default function vercelServerless({ webAnalytics, speedInsights, includeFiles: _includeFiles, excludeFiles: _excludeFiles, imageService, imagesConfig, devImageService, functionPerRoute, edgeMiddleware, maxDuration, isr, skewProtection, }?: VercelServerlessConfig): AstroIntegration;
export {};
